...
<button name="ecpay_official_invoice_transfer" class="button-primary" type="submit" value="ecpay_official_invoice_transfer">
    <?php _e('Data transfer', 'ry-woocommerce-ecpay-invoice'); ?>
</button>
