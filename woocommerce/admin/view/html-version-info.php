<tr valign="top">
    ...
    <td class="forminp">
        <?php esc_html_e('Now Version:', 'ry-woocommerce-ecpay-invoice'); ?> <?=$version ?>
        <?php if ($version_info && version_compare($version, $version_info['version'], '<')) { ?>
        <?php set_site_transient('update_plugins', []); ?>
        <br><span style="color:blue"><?php esc_html_e('New Version:', 'ry-woocommerce-ecpay-invoice'); ?></span> <?php echo esc_html($version_info['version']); ?>
